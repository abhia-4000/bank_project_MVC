...
function amtclick() {
		alert("Amount Should be greater than 500 Rs..")	
}

function ragisterClick() {
	document.myfrom.action="register";
    ...
    <form name="myfrom">
        ...
        <div id="reg">
          ...
          <div class="A">
            ...
            <div >
            <input type="text" onclick="amtclick()" id="amt" name="amount" placeholder="Enter Ammount" required>
             </div>
        </div>
        </div>
        </div>
        ...
        <div class="submit">
          <input type="submit" onclick="ragisterClick()" id="btnRegister">
        </div>
        <div class="fpass">
