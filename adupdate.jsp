...
<body>
	<section>
		<form action="adupdatedata">
			<div class="content">
				<h1 class="name">Update Your Info</h1>
				<div id="full">
					<div id="reg">
						<div class="A">
							<label><span>Enter Account Number </span></label>
							<div>
								<input style="cursor: no-drop;" type="text" name="accno" value="${data.accno }"
						...
						<div class="A">
							...
							<div>
								<input style="cursor: no-drop;" type="text" name="amount" value="${data.amount }"
									placeholder="Enter Ammount" readonly="readonly">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="submit">
				<input type="submit" value="Update" id="btnRegister">
			</div>
			</div>
		</form>
	</section>
